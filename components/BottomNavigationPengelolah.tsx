...
export default function BottomNavigation({ activeTab }: BottomNavigationProps) {
  ...
  const navigateToTab = (tab: string) => {
    switch (tab) {
      ...
      case "toko":
        ...
        break
      case "percakapan":
        console.log("/pengelolah/chat/index")
        break
      case "profil":
        router.push("/pengelolah/profile" as any)
        break
    }
  }
  ...
  return (
    <View style={styles.bottomNav}>
      ...
      <TouchableOpacity style={styles.bottomNavItem} onPress={() => router.replace("/pengelolah/chat" as any)}>
